...
class PackageTree {
    constructor(pack) {
        const { getDeclarationRoots, makeTree, freshBranch } = PackageTree;
...
_a = PackageTree;
PackageTree.makeTree = (declarations, branch, specifierAlias) => {
