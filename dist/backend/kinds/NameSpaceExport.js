...
class NamespaceExport extends dox.lib.Dox {
    constructor(context, exportNode, remoteType) {
        super(context);
        this.kind = dox.Kind.NameSpaceExport;
        this.exportNode = exportNode;
        this.remoteType = remoteType;
        const declaration = this.getDeclaration();
        declaration.nameSpace = this.nodeName;
    ...
    get nodeName() {
        return this.exportNode.name.getText();
    }
    getDeclaration() {
        return this.sourceFile.declarationsMap.get(this.nodeName);
    }
