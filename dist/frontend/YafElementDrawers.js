...
class YafElementDrawers {
    constructor(drawerParent, drawer, drawerTrigger, id, parentDrawerElement) {
        ...
        this.eventsList = [
            ...
            [trigger.drawers.resetHeight, () => this.heightControl.resetHeights(true)],
            [
    ...
    get flagCounts() {
        return {
            ...
            inherited: this.drawer.querySelectorAll(":scope > .inherited").length,
        };
    }
}
