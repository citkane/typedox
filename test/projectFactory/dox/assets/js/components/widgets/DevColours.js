...
export class DevColours extends HTMLElement {
    constructor() {
        ...
        this.toggle = () => {
            ...
            !this.connected
                ? devContainer === null || devContainer === void 0 ? void 0 : devContainer.appendChild(this)
                : devContainer === null || devContainer === void 0 ? void 0 : devContainer.removeChild(this);
        };
...
//# sourceMappingURL=DevColours.js.map